...
import { handleUserRequest } from "../handleRequest";
...
export const SignUp = () => {
  const [formValues, setFormValues] = useState<IUser>(initialFormValues);
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Validate form data
    const formErrors: Partial<IUser> = {};
    if (!formValues.name) {
